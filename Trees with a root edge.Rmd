...
it is assumed that the phylogeny without a root is leading, and the other phylogeny has its root removed

it is assumed that the phylogeny with a root is leading, and the other phylogeny is assumed to have a root of length zero
